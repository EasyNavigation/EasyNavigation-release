...
Name:           ros-kilted-easynav-maps-manager
Version:        0.4.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS easynav_maps_manager package

License:        Apache-2.0
URL:            https://index.ros.org/p/easynav_maps_manager/#kilted
...
%description
Easy Navigation: MapsManager package.
